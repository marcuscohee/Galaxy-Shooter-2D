...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource _onEnemyDeathAudioClip;
    void Start()
    {
        ...
        _onEnemyDeathAudioClip = GetComponent<AudioSource>();
        if (_onEnemyDeathAudioClip == null)
        {
